...
namespace TXC.RCS.Migrations
{
    ...
    [Migration("20260817012814_Added_TaskInteractionLogs")]
    partial class Added_TaskInteractionLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TXC.RCS.Locations.AddressMap", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("TmStorage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TmTarget")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TXC_AddressMaps", "_RCS");
                });

            modelBuilder.Entity("TXC.RCS.Locations.StationPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MasterValuesJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("AddressCode", "Port")
                        .IsUnique();

                    b.ToTable("TXC_StationPoints", "_RCS");
                });

            modelBuilder.Entity("TXC.RCS.Tasks.TaskDo", b =>
                {
                    ...
                    b.Property<string>("FetchEquipmentCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FetchMaterialCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FetchOptionCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("FetchTaskSerial")
                        .HasMaxLength(128)
                    ...
                    b.Property<string>("FromTmStorage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("FromTmTarget")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PutEquipmentCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PutMaterialCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PutOptionCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("PutTaskSerial")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("RuntimeVarsJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TaskLifecycleStatus")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ToTmStorage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ToTmTarget")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FetchTaskSerial");

                    b.HasIndex("PutTaskSerial");

                    b.HasIndex("Source");

                    b.ToTable("TXC_Tasks", "_RCS");
                });

            modelBuilder.Entity("TXC.RCS.Tasks.TaskInteractionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TaskId", "CreationTime");

                    b.ToTable("TXC_TaskInteractionLogs", "_RCS");
                });
